...
{#if clicked}
	<button
		...
		class="py-1/2 border-4 border-double border-black bg-red-400 px-2 font-mono text-gray-300 shadow-sm shadow-red-500/50 hover:text-gray-100 enabled:hover:cursor-pointer disabled:text-gray-500"
		>Resign</button
	>
{:else}
	<button
